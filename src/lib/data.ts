...
export const mockOrders: Order[] = [
  ...
  { id: '2', orderNumber: 'ORD1002', date: new Date('2023-10-02'), driver: 'Jane Smith', type: 'Apoyo Compañero', brand: 'LC', fleet: 'ZF EXPRESS', quantity: 2, observations: 'Fragile items inside the main box. Handle with extreme care and ensure it is kept upright at all times.', enteredBy: 'Data Clerk' },
  ...
  { id: '4', orderNumber: 'ORD1004', date: new Date('2023-10-04'), driver: 'Emily Davis', type: 'Arriba de 1000', brand: 'CC', fleet: 'VUELA YA', quantity: 3, observations: 'Customer will call upon arrival to provide final delivery instructions. Do not leave the package unattended.', enteredBy: 'Admin User' },
  { id: '5', orderNumber: 'ORD1005', date: new Date('2023-10-05'), driver: 'John Doe', type: 'Escuelas', brand: 'DD', fleet: 'FLOTA PROPIA', quantity: 1, observations: 'The original delivery address was incorrect. The new address has been updated in the system, please verify before departing.', enteredBy: 'Supervisor Sam' },
];
